...
import numpy as np
import torch
from torch.utils.data import Subset, random_split, TensorDataset, DataLoader
...
class FashionMNIST_truncated(data.Dataset):
    ...
    def __build_truncated_dataset__(self):
        ...
        FashionMNIST_dataobj = torchvision.datasets.FashionMNIST(root=self.root, train=self.train,
