...
def load_data(args, dataset_name):
    ...
    class_num_train, class_num_test, public_train_data_local_dict, public_test_data_local_dict= data_loader(args.dataset, args.data_dir,
...
if __name__ == "__main__":
    ...
    api.do_fedMD_stand_alone(client_models, train_data_local_num_dict, test_data_local_num_dict, train_data_local_dict,
                             test_data_local_dict, args, public_train_data_local_dict, public_test_data_local_dict)
